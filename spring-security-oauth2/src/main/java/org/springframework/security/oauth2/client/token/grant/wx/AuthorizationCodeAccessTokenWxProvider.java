 ...
 * @author Dave Syer
 */
public class AuthorizationCodeAccessTokenWxProvider extends OAuth2AccessTokenSupport implements AccessTokenProvider {
	...
	public boolean supportsResource(OAuth2ProtectedResourceDetails resource) {
		return resource instanceof AuthorizationCodeResourceWxDetails
				&& AuthorizationCodeResourceWxDetails.WX_GRANT_TYPE.equals(resource.getGrantType());
	}
	...
	public String obtainAuthorizationCode(OAuth2ProtectedResourceDetails details, AccessTokenRequest request)
		...
		AuthorizationCodeResourceWxDetails resource = (AuthorizationCodeResourceWxDetails) details;
	...
	public OAuth2AccessToken refreshAccessToken(OAuth2ProtectedResourceDetails resource,
		...
		try {
			...
			throw getRedirectForAuthorization((AuthorizationCodeResourceWxDetails) resource, request);
		}
	}
	...
	private MultiValueMap<String, String> getParametersForTokenRequest(AuthorizationCodeResourceWxDetails resource,
	...
	private MultiValueMap<String, String> getParametersForAuthorizeRequest(AuthorizationCodeResourceWxDetails resource,
			AccessTokenRequest request) {
	...
	private UserRedirectRequiredException getRedirectForAuthorization(AuthorizationCodeResourceWxDetails resource,
			AccessTokenRequest request) {
	...
	protected UserApprovalRequiredException getUserApprovalSignal(AuthorizationCodeResourceWxDetails resource,
			AccessTokenRequest request) {
